...
namespace IziHardGames.BotForTelegram
{
    ...
    public class TelegramClient : IDisposable
    {
        ...
        public TelegramClient(ConfigForBotForTelegram configForBotForTelegram)
        {
            this.config = configForBotForTelegram;
        ...
        private void OnAuthorizationStateUpdated(AuthorizationState authorizationState)
        {
            ...
            else if (_authorizationState is AuthorizationStateWaitRegistration)
            {
                ...
                client.Send(new RegisterUser(firstName, lastName), new AuthorizationRequestHandler(this));
            }
        ...
        {
            private TelegramClient exampleClient;
            public DefaultHandler(TelegramClient exampleClient)
            {
        ...
        private class UpdateHandler : ClientResultHandler
        {
            ...
            public UpdateHandler(TelegramClient exampleClient)
            {
                this.exampleClient = exampleClient;
            }
            ...
            void ClientResultHandler.OnResult(BaseObject obj)
            {
                ...
                else if (obj is Telegram.Td.Api.UpdateNewChat unc)
                {
        ...
        {
            private TelegramClient exampleClient;
            public AuthorizationRequestHandler(TelegramClient exampleClient)
            {
                this.exampleClient = exampleClient;
            }
            void ClientResultHandler.OnResult(BaseObject obj)
